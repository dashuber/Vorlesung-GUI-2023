...
public class LocationsMainModel {
    private final ListProperty<LocationModel> locations = new SimpleListProperty<>(FXCollections.observableList(new ArrayList<>()));
    ...
    public void addLocations(List<LocationModel> newLocations) {
